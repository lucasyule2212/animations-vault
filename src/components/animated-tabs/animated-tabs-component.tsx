        ...
        <div className="flex h-full w-full flex-col items-center justify-evenly md:flex-row">
          {tabs.map((tab) => (
            <motion.div
              ...
              layout
              className={cn(
                'relative flex w-full cursor-pointer items-center gap-2 px-4 py-2 text-sm outline-none transition-colors',
            ...
            >
              ...
              <span className="relative text-nowrap text-inherit">
                {tab.text}
              </span>
            </motion.div>
          ))}
