...
const FamilyDrawerComponent = () => {
  ...
  return (
    <Card className="font-openRunde relative flex min-h-[500px] w-full min-w-[300px] items-center justify-center bg-white p-6">
      <Button
      ...
      <Drawer.Root open={isOpen} onOpenChange={setIsOpen}>
        <Drawer.Portal>
          ...
          <Drawer.Content
            asChild
            className="font-openRunde fixed inset-x-4 bottom-4 z-10 mx-auto max-w-[361px] overflow-hidden rounded-[36px] bg-[#FEFFFE] text-black outline-none md:mx-auto md:w-full"
          >
            <motion.div
              animate={{
